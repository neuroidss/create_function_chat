...
```
[![made schematics and added components to board in kicad](https://github.com/neuroidss/create_function_chat/blob/main/Screenshots/Screenshot%20from%202024-09-03%2010-36-57.png)](https://youtu.be/zwM2IGk3sNg)
```
...
```
[![placed components, routed board in kicad and sent to PCBWay](https://github.com/neuroidss/create_function_chat/blob/main/Screenshots/Screenshot%20from%202024-09-03%2010-42-06.png)](https://youtu.be/gN0P96MXh-8)
-----
```
python create_function_chat.py \
