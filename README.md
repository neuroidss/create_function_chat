...
```
[![made schematics and added components to board in kicad](https://github.com/neuroidss/create_function_chat/blob/main/Screenshots/Screenshot%20from%202024-09-03%2010-36-57.png)](https://drive.google.com/file/d/1SBoUcfkpqZgn9LMp5QHBYxekTythPoBc/view?usp=drive_link)
```
...
```
[![placed components, routed board in kicad and sent to PCBWay](https://github.com/neuroidss/create_function_chat/blob/main/Screenshots/Screenshot%20from%202024-09-03%2010-42-06.png)](https://drive.google.com/file/d/1KlKxXKeW2dRxOLQLuXE4nN_dtM2cNzQg/view?usp=drive_link)
-----
```
python create_function_chat.py \
